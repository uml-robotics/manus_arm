"""autogenerated by genpy from electrode/cat.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','time','electrode/ca[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cat, self).__init__(*args, **kwds)
